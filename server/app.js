...
app.listen(port, () => {
  console.log('DATABASE: ', process.env.DATABASE_HOST, process.env.DATABASE_PORT, process.env.DATABASE_PASSWORD, process.env.DATABASE_USER);
  console.log(`서버가 ${port}번에서 작동중입니다. 찾은거같다 아니엿다`);
});
